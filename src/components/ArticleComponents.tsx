    ...
    <div className={`${className}`}>
      <div className="flex gap-4 justify-center">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center justify-center w-[3rem] h-[3rem] rounded-full bg-primary hover:opacity-80 transition-opacity"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center justify-center w-[3rem] h-[3rem] rounded-full bg-foreground hover:opacity-80 transition-opacity"
...
export function ArticleContent({ children, className = "" }: ArticleContentProps) {
  return (
    <div
      ...
      article-body
      [&_p]:font-normal
      [&_h2]:mt-[1.666em] [&_h2]:mb-[0.666em] [&_h2]:text-[1.125rem] [&_h2]:md:text-[1.3125rem] [&_h2]:lg:text-[1.6875rem] [&_h2]:[&_h2]:font-semibold [&_h2]:tracking-[-0.02em] [&_h2]:leading-[1.6] [&_h2]:lg:leading-[1.4]
      [&_h2:first-child]:mt-0
      [&_h3]:mt-[1.875em] [&_h3]:mb-[0.75em] [&_h3]:[&_h3]:font-bold
      ...
      [&_figcaption]:max-w-[31.25rem] [&_figcaption]:mt-[0.5em] [&_figcaption]:mx-auto [&_figcaption]:mb-[1em] [&_figcaption]:text-muted-foreground [&_figcaption]:text-[0.9375rem] [&_figcaption]:italic [&_figcaption]:text-center
      ...
      [&_.blockquote-big_blockquote]:[&_.blockquote-big_blockquote]:text-[calc(5vw+0.375rem)] [&_.blockquote-big_blockquote]:lg:text-[3.375rem] [&_.blockquote-big_blockquote]:font-extrabold [&_.blockquote-big_blockquote]:leading-[1.2]

      ...
      <main className="flex-grow">
        <CenteredContent className="py-16 md:py-24">
          <article className="prose prose-lg max-w-none">
            {/* Title */}
            <h1 className="text-[4rem] md:text-[6rem] leading-[1.1] mb-12">
              Get in Touch
            </h1>
            ...
            <div className="text-[1.6rem] leading-relaxed">
              <h2 className="text-[2.4rem] md:text-[3rem] mb-8">
                Frequently Asked Questions
              </h2>

              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  <AccordionTrigger className="text-[2rem] md:text-[2.4rem] font-semibold text-left">
